...
call sonokai#highlight('Typedef', s:palette.red, s:palette.none, 'italic')
call sonokai#highlight('Exception', s:palette.red, s:palette.none)
call sonokai#highlight('Conditional', s:palette.red, s:palette.none, 'italic')
call sonokai#highlight('Repeat', s:palette.red, s:palette.none, 'italic')
call sonokai#highlight('Statement', s:palette.red, s:palette.none, 'italic')
